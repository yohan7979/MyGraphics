...
void Game::Render()
{
	...
	
	{
		...
		_deviceContext->VSSetConstantBuffers(0, 1, _constantBuffer.GetAddressOf()); // 상수 버퍼를 통해 버텍스를 (트랜스폼 등) 변화시킨다.
...
void Game::CreateGeometry()
{
	...
	// Vertex Buffer
	{
		...
		desc.Usage = D3D11_USAGE_IMMUTABLE; // don't change (read only)
...
void Game::CreateSRV()
{
	...
	HRESULT hr = ::LoadFromWICFile(L"SM_SteelBreastplate.png", WIC_FLAGS_NONE, &md,img);
	CHECK(hr);
